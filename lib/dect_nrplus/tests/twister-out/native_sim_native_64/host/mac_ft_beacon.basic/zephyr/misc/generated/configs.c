...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PM_PARTITION_SIZE_ZMS_STORAGE, 0x6000);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DECT_NRPLUS_STACK, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DECT_APP_MAIN_LOG_LEVEL, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DECT_APP_TX_INTERVAL_S, 10);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DECT_NRPLUS_LOG_LEVEL, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DECT_CVG_LOG_LEVEL, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DECT_DLC_LOG_LEVEL, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DECT_CDD_LOG_LEVEL, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DECT_MAC_API_LOG_LEVEL, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DECT_MAC_CORE_LOG_LEVEL, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DECT_MAC_DATA_PATH_LOG_LEVEL, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DECT_MAC_DISPATCHER_LOG_LEVEL, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DECT_MAC_MGMT_LOG_LEVEL, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DECT_MAC_NVS_LOG_LEVEL, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DECT_MAC_PDU_LOG_LEVEL, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DECT_MAC_PHY_CTRL_LOG_LEVEL, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DECT_MAC_PHY_IF_LOG_LEVEL, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DECT_MAC_SECURITY_LOG_LEVEL, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DECT_MAC_SM_FT_LOG_LEVEL, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DECT_MAC_SM_PT_LOG_LEVEL, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DECT_MAC_LAYER, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DECT_MAC_ROLE_IS_PT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DECT_MAC_ROLE_PT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DECT_MAC_THREAD_STACK_SIZE, 4096);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DECT_MAC_THREAD_PRIORITY, 7);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DECT_MAC_THREAD_SERVICE_INTERVAL_MS, 50);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DECT_MAC_NETWORK_ID_MS24_PREFIX, 0xDECC00);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DECT_MAC_PROVISIONED_LONG_RD_ID, 0x0);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DECT_MAC_OWN_MU_CODE, 0);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DECT_MAC_OWN_BETA_CODE, 0);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DECT_MAC_NVS_ZMS_BLOCK_SIZE, 4096);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DECT_MAC_PT_KEEP_ALIVE_MS, 20000);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DECT_MAC_PT_MOBILITY_ENABLE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DECT_MAC_PT_MOBILITY_SCAN_MS, 60000);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DECT_MAC_PT_PAGING_CYCLE_MS, 1280);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DECT_MAC_PT_HARQ_TX_PROC_CODE, 2);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DECT_MAC_PT_HARQ_RETX_DELAY_PT_CODE, 10);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DECT_MAC_PT_HARQ_RX_PROC_CODE, 2);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DECT_MAC_PT_HARQ_RERX_DELAY_PT_CODE, 10);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DECT_MAC_KEEP_ALIVE_MS, 20000);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DECT_MAC_FT_COUNT_TO_TRIGGER_CODE, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DECT_MAC_FT_REL_QUALITY_CODE, 2);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DECT_MAC_FT_MIN_QUALITY_CODE, 0);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DECT_MAC_FT_CLUSTER_BEACON_MS, 100);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DECT_MAC_FT_NETWORK_BEACON_MS, 1000);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DECT_MAC_FT_MAX_ASSOCIATED_PTS, 8);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DECT_MAC_FT_SECURE_ON_ASSOC, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DECT_MAC_FT_DEFAULT_OPERATING_CHANNEL, 0);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DECT_MAC_DCS_NUM_CHANNELS_TO_SCAN, 5);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DECT_MAC_DCS_CHANNEL_LIST, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DECT_MAC_DCS_NOISY_THRESHOLD_DBM, -70);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DECT_MAC_DCS_ACCEPTABLE_BUSY_PERCENT, 20);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DECT_MAC_FT_HARQ_TX_PROC_CODE, 2);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DECT_MAC_FT_HARQ_RETX_DELAY_CODE, 10);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DECT_MAC_FT_HARQ_RX_PROC_CODE, 2);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DECT_MAC_FT_HARQ_RERX_DELAY_CODE, 10);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DECT_MAC_FT_DEFAULT_SCHEDULE_REPEAT_FRAMES, 10);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DECT_MAC_FT_DEFAULT_SCHEDULE_VALIDITY_FRAMES, 100);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DECT_MAC_FT_SCHEDULE_START_SFN_OFFSET, 2);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DECT_MAC_RSSI_THR_MIN_DBM, -90);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DECT_MAC_RSSI_THR_MAX_DBM, -75);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DECT_MAC_RACH_CW_MIN_IDX, 2);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DECT_MAC_RACH_CW_MAX_IDX, 6);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DECT_MAC_RACH_RESP_WIN_MS, 200);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DECT_MAC_DEFAULT_DATA_MCS, 0);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DECT_MAC_SCHEDULE_PROCESSING_DELAY_US, 5000);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DECT_MAC_CAP_RELEASE_VERSION, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DECT_MAC_CAP_SUPPORTS_PAGING, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DECT_MAC_CAP_SUPPORTS_SCHED_DATA, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DECT_MAC_CAP_DLC_SERVICE_SUPPORT_CODE, 5);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DECT_MAC_CAP_RX_TX_DIVERSITY_CODE, 0);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DECT_MAC_CAP_MAX_NSS_RX_CODE, 0);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DECT_MAC_CAP_MAX_MCS_CODE, 11);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DECT_MAC_CAP_HARQ_BUFFER_CODE, 7);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DECT_MAC_CAP_NUM_HARQ_PROC_CODE, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DECT_MAC_CAP_HARQ_FEEDBACK_DELAY_CODE, 0);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DECT_MAC_CAP_SUPPORTS_DECT_DELAY, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DECT_MAC_CAP_SUPPORTS_HALF_DUPLEX, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DECT_MAC_PDU_MAX_SIZE, 4096);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DECT_MAC_SDU_MAX_SIZE, 1636);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DECT_MAC_PCC_CACHE_SIZE, 8);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DECT_MAC_PCC_CACHE_TIMEOUT_MS, 50);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DECT_DLC_LAYER, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DECT_DLC_RX_THREAD_STACK_SIZE, 2048);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DECT_DLC_RX_THREAD_PRIORITY, 5);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DECT_DLC_TX_SERVICE_THREAD_STACK_SIZE, 2048);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DECT_DLC_TX_SERVICE_THREAD_PRIORITY, 5);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DECT_DLC_MAX_SDU_PAYLOAD_SIZE, 1500);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DECT_DLC_DEFAULT_SDU_LIFETIME_MS, 5000);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DECT_CVG_LAYER, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DECT_CVG_TX_THREAD_STACK_SIZE, 2048);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DECT_CVG_TX_THREAD_PRIORITY, 5);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DECT_CVG_RX_THREAD_STACK_SIZE, 2048);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DECT_CVG_RX_THREAD_PRIORITY, 5);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DECT_CVG_TX_SERVICE_THREAD_STACK_SIZE, 2048);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DECT_CVG_TX_SERVICE_THREAD_PRIORITY, 5);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DECT_CDD_LAYER, 1);
